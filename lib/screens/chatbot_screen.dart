          ...
          if (_isLoading)
            const Padding(
              ...
              child: CircularProgressIndicator(
                valueColor: AlwaysStoppedAnimation<Color>(Color.fromARGB(255, 182, 107, 198)),
              ),
            ),
          Container(
            padding: const EdgeInsets.all(16),
                  ...
                  children: [
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(24),
                            borderSide: const BorderSide(color: Color.fromARGB(255, 222, 198, 234)),
                          ),
                        ),
                      ),
                    ),
                    ...
                    IconButton(
                      ...
                      style: IconButton.styleFrom(
                        backgroundColor: _isListening ? const Color.fromRGBO(237, 141, 134, 1) : const Color.fromARGB(255, 168, 154, 178),
